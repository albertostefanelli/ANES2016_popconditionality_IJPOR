##### READ MPLUS .OUT FILES TO GENERATE FIGURE 13 IN THE APPENDIX #####
...
mod_to_read <- "F_APPENDIX_sanders.out"
...
ggsave(here("figures", "APPENDIX_sanders_ideological.png"),width=990*3,height=250*3, dpi=300,  units = "px")
...
ggsave(here("figures", "APPENDIX_sanders_affective.png"),width=990*3,height=250*3, dpi=300,  units = "px")
