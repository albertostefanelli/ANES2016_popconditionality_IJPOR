##### FIT MODEL WITH MPLUS TO GENERATE FIGURE 6 IN THE APPENDIX #####
...
# how much they like their leader taking into account other leader evaluation.
data_mplus$leader_f_l <- ifelse(base_cleaned$PID_2_REP =="REP",
                                  (base_cleaned$V161087 - base_cleaned$V161086),
                                  (base_cleaned$V161086 - base_cleaned$V161087)
)
...
model_out <- "F_APPENDIX_AFF_diff_leaders.inp"
