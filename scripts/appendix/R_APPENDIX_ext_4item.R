##### READ MPLUS .OUT FILES TO GENERATE FIGURE 4 IN THE APPENDIX #####
...
mod_to_read <- "APPENDIX_ext_4item.out"
...
ggsave(here("figures", "APPENDIX_ext_4items.png"),width=990*3,height=250*3, dpi=300,  units = "px")
