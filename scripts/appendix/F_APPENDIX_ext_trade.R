...
# Favor/oppose free trade agreements
data_mplus$trade_ext <- sqrt((data_mplus[["V162176x"]] - 4)^2)
...
model <- paste(
  ...
  [trade_ext] (extb0g1);         ! free intercept
  trade_ext (vareg1);            ! free residual

  !!! freely estimated slopes !!!
  trade_ext ON POP (extb1g1);
  trade_ext ON bernie (extb2g1); !fixed
  ...
  wagner_aff WITH trade_ext (covg1);


  trade_ext ON EFFI (exts01g1) ! internal efficacy
  ...
  [trade_ext] (extb0g3);        ! free intercept
  trade_ext (vareg3);           ! free residual

  !!! freely estimated slopes !!!
  trade_ext ON POP (extb1g3);
  trade_ext ON bernie (extb2g1);! fixed
  ...
  wagner_aff WITH trade_ext (covg3);
...
model_out <- "F_APPENDIX_ext_trade.inp"
