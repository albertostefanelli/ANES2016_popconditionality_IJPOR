##### READ MPLUS .OUT FILES TO GENERATE FIGURE 15 & 16 IN THE APPENDIX #####
...
mod_to_read <- "F_APPENDIX_efficacy.out"
...
ggsave(here("figures", "APPENDIX_ideological_efficacy.png"),width=990*3,height=250*3, dpi=300,  units = "px")
...
ggsave(here("figures", "APPENDIX_affective_efficacy.png"),width=990*3,height=250*3, dpi=300,  units = "px")
