##### READ MPLUS .OUT FILES TO GENERATE FIGURE 9 & 10 IN THE APPENDIX #####
...
mod_to_read <- "F_APPENDIX_5item.out"
...
ggsave(here("figures", "APPENDIX_5item_ideological.png"),width=990*3,height=250*3, dpi=300,  units = "px")
...
ggsave(here("figures", "APPENDIX_5item_affective.png"),width=990*3,height=250*3, dpi=300,  units = "px")
