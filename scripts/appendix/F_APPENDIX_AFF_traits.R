##### FIT MODEL WITH MPLUS TO GENERATE FIGURE 8 IN THE APPENDIX #####
...
# in-/out-party candidate trait really cares
data_mplus$care_l <- ifelse(data_mplus$PID_2_REP =="REP", data_mplus$V161160 - base_cleaned$V161165,
                            base_cleaned$V161165 - data_mplus$V161160)
# in-/out-party candidate trait knowledgeable
data_mplus$know_l <- ifelse(data_mplus$PID_2_REP =="REP", data_mplus$V161161 - base_cleaned$V161166,
                            base_cleaned$V161166 - data_mplus$V161161)
# in-/out-party candidate trait honest
data_mplus$honest_l <- ifelse(data_mplus$PID_2_REP =="REP", data_mplus$V161162 - base_cleaned$V161167,
                              base_cleaned$V161167 - data_mplus$V161162)
...
model <- paste(
  ...
  [aff_t] (affb0g1);  ! free intercept
  aff_t (varag1);     ! free residual

  !!! freely estimated slopes !!!
  aff_t ON POP (affb1g1);
  aff_t ON bernie (affb2g1);

  aff_t WITH EXT (covg1);
  ...
  aff_t ON EFFI (affs01g1) ! internal efficacy
  ...
  [aff_t] (affb0g3); ! free intercept
  [know_l@0];        ! fixed intercept
  aff_t (varag3);    ! free residual

  !!! freely estimated slopes !!!
  aff_t ON POP (affb1g3);
  aff_t ON bernie (affb2g1);

  aff_t WITH EXT (covg3);
...
model_out <- "F_APPENDIX_aff_traits.inp"
